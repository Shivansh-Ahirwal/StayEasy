/**
 * Lightweight inline SVG icon set (Lucide design language, MIT).
 * Zero runtime dependencies — works before lucide-react is installed.
 * Swap to lucide-react imports directly whenever the package is available.
 */

function Svg({ size = 16, strokeWidth = 2, className = '', style, children }) {
  return (
    <svg
...
export function LayoutDashboard(p) {
  return (
    <Svg {...p}>
